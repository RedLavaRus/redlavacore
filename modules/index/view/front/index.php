...
<head>
    ...
    <title>ТТК - подключить интернет</title>
   ...
   <div class="line2">
    ...
    <div class="tp_box">
        ...
        <div class="tp_box_in">
            ...
            <b>100</b> Мбит/сек<br>
            <b>67</b> ТВ-каналов<br>
            
            </div>
            <div class="tp_box_prise">
            
            <b>209</b> <small><small> руб/мес </small></small>
            </div>
            <a href="/connect/5">
                <div class="tp_box_connect">
                    ПОДКЛЮЧИТЬ
        ...
        <div class="tp_box_in">
            ...
            <div class="tp_box_name">
            Простой <br> + тв приставка<br>
            </div>
            <div class="tp_box_opis">

            <b>100</b> Мбит/сек<br>
            <b>67</b> ТВ-каналов<br> <b>ТВ-приставка</b><br>
    ...
    <h4>Плановые профилактические работы</h4>
        ...
        <div class="coonect">
            <div class="coonect_in">
                Контактный телефон, отдела подключений:&nbsp;&nbsp;&nbsp; <b>+7 (960) 49 44 999</b> г.Краснодар
            </div>
        </div>
        <div class="footer">
        <div class="footer_in">
